...
module switch_high_radix_matching #(
    ...
    for (genvar r = 0; r < NUM_VOQ; r++) begin : g_voq_rep
        ...
        delayed_regs #(
            .WIDTH      (1),
            .NUM_DELAY  (NUM_XPQ_COL-1)
        ) u_del_push_r (
            .clk            (clk),
            .signal_in      ( voq_cell_valid[r] ),
            .delayed_signal ( rep_push[r] )
        );
        ...
        delayed_regs #(
            ...
            .delayed_signal ( rep_last_cell[r] )
        );
        ...
        delayed_regs #(
            ...
            .delayed_signal ( rep_xpq_index[r] )
        );
