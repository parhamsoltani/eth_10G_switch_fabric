	vlog -vopt -sv	+acc -incr -source +define+SIM +incdir+$sim_include_path "tb/dfifo/*.sv"
	vlog -vopt -sv	+acc -incr -source +define+SIM +incdir+$sim_include_path "hvl/dfifo_models/*.sv"
